...
// export const WeakList: React.FC<Props> = ({ weakPoints, isAdmin = false, onDelete, onAdd, onEdit }) => {
//   // Add State
...
//   return (
//     <Card title="취약 단원" icon={<AlertTriangle className="text-orange-500" size={20} />}>
//       <div className="space-y-3">
//         {weakPoints.length === 0 && (
//           <div className="text-center py-4 text-gray-400 text-sm">등록된 취약 단원이 없습니다.</div>
//         )}
...
//                <Plus size={12} /> 새로운 취약점 추가
//              </h4>
//              <div className="space-y-2">
//                <input 
//                  type="text" 
//                  placeholder="단원명 (예: 삼각함수)" 
//                  value={newCategory}
